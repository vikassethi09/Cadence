...
class NotificationService {
  ...
  Future<void> snoozeHabit(int habitId, String habitName) async {
    ...
    await _plugin.zonedSchedule(
      ...
      scheduledDate: when,
      notificationDetails: const NotificationDetails(
        android: AndroidNotificationDetails(_channelId, 'Habit reminders', category: AndroidNotificationCategory.reminder, actions: _actions),
        iOS: DarwinNotificationDetails(categoryIdentifier: 'habit_reminder'),
      ),
  ...
  Future<void> scheduleStreakSweep({required int minutesOfDay, required String body}) async {
    ...
    await _plugin.zonedSchedule(
      ...
      scheduledDate: when,
      notificationDetails: const NotificationDetails(
        android: AndroidNotificationDetails(_streakChannelId, 'Streak at risk', category: AndroidNotificationCategory.reminder),
